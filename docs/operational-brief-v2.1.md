# UK Mortgages Worldwide - Operational Brief v2.1

**Status:** Living document. Update at the end of every working session.
**Last updated:** 05 May 2026
**Replaces:** operational-brief-v2.0.md.
**v2.1 changes:** Added §4.5 standard top-of-page disclaimer. Updated §7.2 V1.docx contents to reference §4.5.
...
### 4.5 Standard top-of-page disclaimer (website and V1 articles)

The same disclaimer block must render under the H1 on every page of the website AND under the H1 of every V1 news article. Two variants only.

**Residential variant** (used on residential hubs, residential country pages, residential situation pages, residential guides, residential news, homepage):
...
**BTL variant** (used on BTL hubs, BTL situation pages, BTL guides, BTL news):
...
Rendering rules:
- Centred, bold on V1 articles, same font as page body
- Immediately after H1, before any body content or source citation
- Position is fixed. Never mid-paragraph. Never below the lead.
- Website: rendered via RiskWarning + TerritorialScope components, do not hard-code
- V1.docx: rendered as bold paragraph(s) at the top of the article body
- Wording is locked. Any future change must update §4.5 first, then propagate to website components and to every V1 article subsequently published.
...
**V1.docx contains:**
- H1
- Standard disclaimer block per §4.5 (residential or BTL variant), centred, bold, immediately under the H1, before body text
...
- The disclaimer block in any position other than directly under H1
